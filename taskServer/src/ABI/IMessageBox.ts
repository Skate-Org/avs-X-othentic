...
export const AvsIntent_ABIParameter = parseAbiParameters([
  "AvsIntent[] verifiedIntents",
  "struct AvsIntent { uint256 taskId; address appAddress; bytes taskCalldata; address user; uint256 chainId; address messageBox; uint256 taskDefinitionId; bytes32 transactionHash; }",
] as const);
